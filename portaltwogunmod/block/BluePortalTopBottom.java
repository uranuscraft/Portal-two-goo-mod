...
public class BluePortalTopBottom extends Block {
	
	 
	
	public BluePortalTopBottom(int par1, Material par2Material) {
...
BluePortalBlock.onCollided(world, par2, par3, par4, entity);
	    ...
	    public void onBlockAdded(World world,int par2, int par3, int par4) {
	    	...
	    	BluePortalBlock.setBlueCoords(par2, par3, par4);
	    	onadded = true;
	    }
